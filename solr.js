...
Client.prototype.update = function(data,options,callback){
   ...
   this.options.json = JSONbig.stringify(data);
...
Client.prototype.get = function(handler,query,callback){
   ...
   if(typeof query === 'function'){
      ...
      // parameters += '&hl=true&hl.fl=*&hl.snippets=10000&fl=*,score&hl.simple.pre=<mark>&hl.simple.post=</mark>';
   }
...
Client.prototype.gethl = function(handler,query,callback){
